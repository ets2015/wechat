...
import me.hao0.wechat.model.message.receive.event.card.*;
import me.hao0.wechat.model.message.receive.event.menu.RecvMenuClickEvent;
import me.hao0.wechat.model.message.receive.event.menu.RecvMenuViewEvent;
...
public final class Messages extends Component {
    ...
    private RecvMessage parse2RecvEvent(XmlReaders readers, RecvMessage msg) {
        ...
        switch (type) {
            ...
            case MENU_CLICK:
                RecvMenuClickEvent recvMenuClickEvent = new RecvMenuClickEvent(event);
                recvMenuClickEvent.setEventKey(readers.getNodeStr("EventKey"));
                return recvMenuClickEvent;
            case MENU_VIEW:
                RecvMenuViewEvent recvMenuViewEvent = new RecvMenuViewEvent(event);
                recvMenuViewEvent.setEventKey(readers.getNodeStr("EventKey"));
                return recvMenuViewEvent;
            ...
            //领取事件
            case USER_GET_CARD:
                RecvUserGetCardEvent recvUserGetCardEvent = new RecvUserGetCardEvent(event);
                recvUserGetCardEvent.setCardId(readers.getNodeStr("CardId"));
                recvUserGetCardEvent.setIsGiveByFriend(Integer.valueOf(readers.getNodeStr("IsGiveByFriend")) != 0);
                recvUserGetCardEvent.setUserCardCode(readers.getNodeStr("UserCardCode"));
                recvUserGetCardEvent.setFriendUserName(readers.getNodeStr("FriendUserName"));
                recvUserGetCardEvent.setOuterId(Integer.valueOf(readers.getNodeStr("OuterId")));
                recvUserGetCardEvent.setOldUserCardCode(readers.getNodeStr("OldUserCardCode"));
                recvUserGetCardEvent.setOuterStr(readers.getNodeStr("OuterStr"));
                recvUserGetCardEvent.setIsRestoreMemberCard(Integer.valueOf(readers.getNodeStr("IsRestoreMemberCard")) != 0);
                recvUserGetCardEvent.setIsRecommendByFriend(Integer.valueOf(readers.getNodeStr("IsRecommendByFriend")) != 0);
                return recvUserGetCardEvent;

            //核销事件
            case USER_CONSUME_CARD:
                RecvUserConsumeCardEvent recvUserConsumeCardEvent = new RecvUserConsumeCardEvent(event);
                recvUserConsumeCardEvent.setCardId(readers.getNodeStr("CardId"));
                recvUserConsumeCardEvent.setUserCardCode(readers.getNodeStr("UserCardCode"));
                recvUserConsumeCardEvent.setConsumeSource(readers.getNodeStr("ConsumeSource"));
                recvUserConsumeCardEvent.setLocationName(readers.getNodeStr("LocationName"));
                recvUserConsumeCardEvent.setStaffOpenId(readers.getNodeStr("StaffOpenId"));
            ...
            case USER_PAY_FROM_PAY_CELL:
                RecvUserPayFromPayCellEvent recvUserPayFromPayCellEvent = new RecvUserPayFromPayCellEvent(event);
                recvUserPayFromPayCellEvent.setCardId(readers.getNodeStr("CardId"));
                recvUserPayFromPayCellEvent.setUserCardCode(readers.getNodeStr("UserCardCode"));
                recvUserPayFromPayCellEvent.setTransId(readers.getNodeStr("TransId"));
                recvUserPayFromPayCellEvent.setLocationId(readers.getNodeStr("LocationId"));
                recvUserPayFromPayCellEvent.setFee(Integer.valueOf(readers.getNodeStr("Fee")));
                recvUserPayFromPayCellEvent.setOriginalFee(Integer.valueOf(readers.getNodeStr("OriginalFee")));
                return recvUserPayFromPayCellEvent;

            //积分余额变更事件
            case UPDATE_MEMBER_CARD:
                RecvUpdateMemberCardEvent recvUpdateMemberCardEvent = new RecvUpdateMemberCardEvent(event);
                recvUpdateMemberCardEvent.setCardId(readers.getNodeStr("CardId"));
                recvUpdateMemberCardEvent.setUserCardCode(readers.getNodeStr("UserCardCode"));
                recvUpdateMemberCardEvent.setModifyBalance(Integer.valueOf(readers.getNodeStr("ModifyBalance")));
            ...
            case POI_CHECK_NOTIFY:
                RecvPoiCheckNotifyEvent recvPoiCheckNotifyEvent = new RecvPoiCheckNotifyEvent(event);
                recvPoiCheckNotifyEvent.setUniqId(readers.getNodeStr("UniqId"));
                recvPoiCheckNotifyEvent.setPoiId(readers.getNodeStr("PoiId"));
                recvPoiCheckNotifyEvent.setResult(readers.getNodeStr("Result"));
                recvPoiCheckNotifyEvent.setMsg(readers.getNodeStr("msg"));
                return recvPoiCheckNotifyEvent;
